 ...
 */
public class FoodListAdapter extends ParseQueryAdapter<FoodItem> {
    ...
    public FoodListAdapter(Context context) {
        super(context, new ParseQueryAdapter.QueryFactory<FoodItem>() {
            public ParseQuery<FoodItem> create() {
                ...
                return ParseQuery.getQuery(FoodItem.class).whereNotEqualTo("user", ParseUser.getCurrentUser());
            }
        });
